...
export const demoTransferPlayers = [
  {
    ...
    currentTeam: { id: "northbridge", name: "Northbridge FC", shortName: "NBR", imageUrl: null, league: { id: "demo-league", name: "Demo Premier League", imageUrl: null } },
  ...
  },
  {
    ...
    physical: 70,
    marketValue: 8500000,
    currentTeam: { id: "riverside", name: "Riverside Athletic", shortName: "RSA", imageUrl: null, league: { id: "demo-league", name: "Demo Premier League", imageUrl: null } },
